...
# see install section in container.md, deploy files manually
# to avoid direct start systemd service and avoid stop daemon in apt upgrade
...
packages_path = pathlib.Path('docker-packages')
...
other_files = list(map(pathlib.Path, [
    ...
    'docker-packages/containerd.io/usr/share/man/man8/containerd-config.8.gz',
    'docker-packages/containerd.io/usr/share/man/man8/ctr.8.gz',
    'docker-packages/containerd.io/usr/share/man/man8/containerd.8.gz',
    'docker-packages/containerd.io/usr/share/man/man5/containerd-config.toml.5.gz',
    'docker-packages/containerd.io/usr/share/doc/containerd.io/changelog.Debian.gz',
    'docker-packages/containerd.io/usr/share/doc/containerd.io/copyright',
    'docker-packages/docker-compose-plugin/usr/share/doc/docker-compose-plugin/README.md',
    'docker-packages/docker-compose-plugin/usr/share/doc/docker-compose-plugin/changelog.Debian.gz',
    'docker-packages/docker-ce/usr/share/man/man8/dockerd.8.gz',
    'docker-packages/docker-ce/usr/share/doc/docker-ce/README.md',
    'docker-packages/docker-ce/usr/share/doc/docker-ce/changelog.Debian.gz',
    # not important traditional service
    'docker-packages/docker-ce/etc/default/docker',
    'docker-packages/docker-ce/etc/init.d/docker',
    'docker-packages/docker-ce-cli/usr/share/man/man5/Dockerfile.5.gz',
    'docker-packages/docker-ce-cli/usr/share/man/man5/docker-config-json.5.gz',
    # not important shell completions
    'docker-packages/docker-ce-cli/usr/share/fish/vendor_completions.d/docker.fish',
    'docker-packages/docker-ce-cli/usr/share/zsh/vendor-completions/_docker',
    'docker-packages/docker-ce-cli/usr/share/bash-completion/completions/docker',
    'docker-packages/docker-ce-cli/usr/share/doc/docker-ce-cli/changelog.Debian.gz',
]))
    ...
    if directory_path != packages_path:
        for file_name in file_names:
            ...
            if file_path not in major_files and file_path not in other_files:
                ...
                if not str(file_path).startswith('docker-packages/docker-ce-cli/usr/share/man/man1/'):
                    has_error = True
